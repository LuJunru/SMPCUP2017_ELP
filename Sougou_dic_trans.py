...
'''
The function of this python file is to transfer SouGou's Word Vocabulary from SCEL form into TXT form.
Original code can be viewed on: http://blog.sina.com.cn/s/blog_5357c0af0101jalh.html
'''
...
if __name__ == '__main__':
    ...
    # 将要转换的词库添加在这里就可以了
    o = eachFile("/Users/admin1/Desktop/2")

    for f in o:
        deal(f)

        # 保存结果
    f = open('/Users/admin1/Desktop/sougou.txt', 'w')
